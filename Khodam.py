...
def cek_khodam(nama):
    responses = [
        ...
        ("Ifatcu", ["Ifatcu.jpg"]),
        ("Pocong Keram", ["Pocong_Keram.jpg"]),
        ("Tuyul Mulet", ["Tuyul_Mulet.jpg"]),
        ("Haji Thoriq", ["Haji_Thoriq.jpg"]),
        ("Macan Sumbing", ["macan_sumbing.jpg"]),
        ("Tuyul Berhijab", ["Tuyul_Berhijab.jpg"]),
        ("Kunti Bogel", ["Kunti_Bogel.jpg"])
    ]
    # Gunakan waktu dan nama sebagai seed untuk randomisasi
    random.seed(f"{nama}{int(time.time())}")
